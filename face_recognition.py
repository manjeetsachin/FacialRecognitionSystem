...
class FaceRecognition:
    def __init__(self, root):
        ...
        # second Image
        img_bottom = Image.open(r"college_images\facialRecognition1.webp")
        img_bottom = img_bottom.resize((1545, 795), Image.LANCZOS)
        ...
        # BUTTON
        self.b1 = Button(f_lbl, text="Face Recognition", cursor="hand2", command=self.face_recog, font=("times new roman", 18, "bold"), bg="black", fg="white")
        self.b1.place(x=690, y=620, width=200, height=60)

        # Hover effect bindings
        self.b1.bind("<Enter>", self.on_enter_b1)
        self.b1.bind("<Leave>", self.on_leave_b1)

    def on_enter_b1(self, event):
        self.b1.config(bg="gray")

    def on_leave_b1(self, event):
        self.b1.config(bg="black")
